...
public class RestfulUserController {
	...
	public Map<String, Object> getUserList(@PathVariable String id, UserVO vo, Model model) {
		vo.setId(id);
	...
	public Map<String, Boolean> insertUser(@RequestBody UserVO vo, Model model) {
